...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.dittoHarnessStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.dittoHarnessSaveMemory]: AuthOrchestrationOperateScope,
  [WS_METHODS.dittoHarnessSearchMemories]: AuthOrchestrationReadScope,
