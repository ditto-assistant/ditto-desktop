...
function getGnomeKeyringRemediationMessage(): string {
  return "Ditto could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Ditto.";
}

function getKWalletRemediationMessage(): string {
  return "Ditto could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Ditto.";
}
