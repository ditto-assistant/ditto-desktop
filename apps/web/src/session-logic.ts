...
import { ProviderDriverKind, UserInputAttachmentAnswerPayload } from "@t3tools/contracts"; // DITTO: provider picker options
...
// DITTO: provider picker options (upstream moved provider metadata to providerDriverMeta).
